...
class Implementation {
    ...
    private int[] IP = {58, 50, 42, 34, 26, 18,
    ...
    private int[] PC1 = {57, 49, 41, 33, 25,
    ...
    private int[] PC2 = {14, 17, 11, 24, 1, 5, 3,
    ...
    // expansion the 32 bit message block to 48 bit
    private int[] EP = {32, 1, 2, 3, 4, 5, 4,
            5, 6, 7, 8, 9, 8, 9, 10,
    ...
    // convert s-box 48 output to 32 bit message block
    private int[] P = {16, 7, 20, 21, 29, 12, 28,
            17, 1, 15, 23, 26, 5, 18,
            31, 10, 2, 8, 24, 14, 32,
            27, 3, 9, 19, 13, 30, 6,
            22, 11, 4, 25};
    ...
    private String getKey(String key) {
        ...
        key = leftCircularShift(
                key.substring(0, 7), shiftBit)
                + leftCircularShift(key.substring(7, 14), shiftBit);
        // second key permutation
        keys = permutation(PC2, key);
    ...
    public String encrypt(String plainText, String key) {
        ...
        //one round
        plainText = round(plainText, keys);
